...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['resume_content'])) {
    ...
    <head>
        ...
        <style>
            ...
            .left-panel { width: var(--sidebar-width) !important; background-color: var(--sidebar-color) !important; color: white !important; -webkit-print-color-adjust: exact; padding: 30px 20px; }
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* --- SIMPLE PRINT MODE --- */
        body.simple-mode .left-panel {
            background-color: white !important;
            color: #333 !important;
            border-right: 1px solid black !important;
        }

        body.simple-mode .left-panel h3 {
            color: #333 !important;
            border-bottom-color: #333 !important;
        }

        body.simple-mode .info-label {
            color: #555 !important;
        }

        body.simple-mode .skill-tag,
        body.simple-mode .entry-subtitle {
            color: #333 !important;
        ...
        body.simple-mode .right-panel {
            background-color: white !important;
        }

        body.simple-mode .name,
        body.simple-mode .section-title,
        body.simple-mode .job-title {
            color: #333 !important;
        }
        ...
        body.simple-mode .left-panel select,
        body.simple-mode .radio-group {
            color: #333 !important;
        }

        body.simple-mode .entry-title,
        body.simple-mode .entry-date,
        body.simple-mode .entry-content,
        body.simple-mode .entry-subtitle {
            color: #333 !important;
            opacity: 1 !important;
        }

        body.simple-mode #objectiveText,
        body.simple-mode .declaration-text {
            color: #333 !important;
            opacity: 1 !important;
        }

        body.simple-mode .sign-box,
        body.simple-mode .sign-line {
            color: #333 !important;
        ...
        .left-panel body.edit-mode [contenteditable="true"] {
...
<body class="edit-mode">
        ...
        <div class="left-panel">
                ...
                <div class="info-item">
                    ...
                    <div class="radio-group">
                        ...
                        <label><input type="radio" name="gender" value="Female" onclick="updateRadioClasses()">
                            Female</label>
                        <label><input type="radio" name="gender" value="Other" onclick="updateRadioClasses()">
                            Other</label>
                    </div>
                    <button class="remove-btn-skill" onclick="removeElement(this.parentElement)">x</button>
                </div>
            ...
            <div class="section">
                ...
                <div class="skills-container" id="skillsList">
                    <div class="skill-tag"><span contenteditable="true">HTML</span><button class="remove-btn-skill"
                            onclick="removeElement(this.parentElement)">x</button></div>
                    <div class="skill-tag"><span contenteditable="true">CSS</span><button class="remove-btn-skill"
                            onclick="removeElement(this.parentElement)">x</button></div>
                    <div class="skill-tag"><span contenteditable="true">PHP</span><button class="remove-btn-skill"
                            onclick="removeElement(this.parentElement)">x</button></div>
                </div>
            ...
            <div class="section">
                <h3>Hobbies</h3>
                <div id="hobbiesList">
                    <div class="skill-tag" style="display:block; margin-bottom:5px;"><span
                            contenteditable="true">Reading</span><button class="remove-btn-skill"
                            onclick="removeElement(this.parentElement)">x</button></div>
                </div>
        ...
        <div class="right-panel">
            ...
            <div class="section-right">
                ...
                <div id="objectiveText" contenteditable="true" style="min-height: 40px; line-height:1.6;">
                    Seeking a full-time position where I can apply my technical skills and contribute to organizational
                    growth.
                </div>
                <div class="objective-controls ui-controls">
                    <select
                        ...
                        <option value="Seeking a full-time position where I can apply my technical skills...">Full Time
                            Growth</option>
                        <option value="To obtain a challenging role that allows me to enhance my skills...">Challenging
                            Role</option>
                        <option value="Looking for an entry-level opportunity to start my career...">Entry Level
                        </option>
                    </select>
                </div>
            </div>
            ...
            <div class="section-right">
                <div class="section-title">
                    ...
                    <div class="ui-controls" id="fresherControl"
                        style="font-size:0.7rem; text-transform: none; position: absolute; right: 0; font-weight: normal;">
                ...
                <div id="experienceSection">
                    <div class="entry">
                        ...
                        <div class="entry-content" contenteditable="true">Led development of multiple web applications
                            using PHP and React.</div>
            ...
            <button class="add-btn" style="width: auto; margin-bottom: 20px;" onclick="addCustomSection()">+ Add Custom
                Section</button>
    ...
    <div class="editor-panel">
        ...
        <div class="control-group">
            ...
            <input type="color" value="#2c3e50" oninput="updateVar('--primary-color', this.value)"
                style="width:100%; height:40px; border:none; padding:0;">
        </div>

        <div class="control-group">
            <label>Sidebar Color</label>
            <input type="color" value="#2c3e50" oninput="updateVar('--sidebar-color', this.value)"
                style="width:100%; height:40px; border:none; padding:0;">
        </div>
        ...
        <div style="margin-top:auto;">
            ...
            <button class="btn btn-outline-blue" onclick="printSimple()" style="margin-top:5px;">Print Simple
                (B&W)</button>
        </div>
    </div>
    ...
    <script>
        ...
        function prepareSave() {
            ...
            let cssVars = "";
            ['--base-font-size', '--section-gap', '--content-padding', '--item-gap', '--sidebar-width', '--line-height', '--primary-color', '--sidebar-color', '--text-color', '--accent-color'].forEach(v => {
        ...
        function printSimple() {
            ...
            setTimeout(() => {
                ...
                // Remove class after print dialog (or immediately if background print)
                // Note: user won't see reversal until dialog closes in most browsers
                // setTimeout(() => document.body.classList.remove('simple-mode'), 500); 
            }, 100);

            // Safer to use onafterprint event if supported, but timeout is generic
