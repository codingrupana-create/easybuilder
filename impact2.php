...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['resume_content'])) {
    ...
    $filename = "resume_impact_" . date('Y-m-d_H-i') . ".html";
...
<head>
    ...
    <title>Impact Resume Builder</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .header-section h1.name {
            font-family: 'Montserrat', sans-serif; font-size: 3em; font-weight: 800; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 5px;
        }
        .header-section .job-title {
            font-family: 'Montserrat', sans-serif; font-size: 1.2em; text-transform: uppercase; letter-spacing: 4px; color: var(--primary-color); font-weight: 600;
        }
        ...
        .contact-bar {
            ...
            display: flex; justify-content: center; flex-wrap: wrap; gap: var(--item-gap);
            font-size: 0.9em; align-items: center;
            margin-bottom: var(--section-gap);
        }

        .contact-item { display: flex; align-items: center; position: relative; }
        .contact-item:not(:last-child)::after { content: "|"; margin-left: 10px; opacity: 0.5; position: absolute; right: -10px; }

        /* --- BODY --- */
        .resume-body { display: flex; flex-grow: 1; }

        .main-content {
            flex: 1;
            padding: 0 30px 30px var(--content-padding);
            background: white;
        ...
        /* --- SECTIONS --- */
        .section {
            position: relative; /* Crucial for Delete Button Positioning */
        }

        .section-title {
            font-family: 'Montserrat', sans-serif; font-size: 1.1em; color: #222; text-transform: uppercase;
            border-bottom: 2px solid var(--primary-color); padding-bottom: 5px; margin-bottom: 15px; font-weight: 700;
        ...
        .entry, .sidebar-item { position: relative; page-break-inside: avoid; padding-right: 20px; margin-bottom: 0; }
        .entry-header { display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 2px; }
        .entry-title { font-weight: 700; font-size: 1.05em; color: var(--primary-color); }
        .entry-date { font-weight: 600; font-size: 0.9em; color: #666; text-align: right; min-width: 100px; }
        .entry-subtitle { font-weight: 700; color: #444; font-size: 0.95em; margin-bottom: 5px; }
        .entry-content { font-size: 0.95em; line-height: var(--line-height); color: #555; text-align: justify; }

        .sidebar-item { font-size: 0.9em; }
        .sidebar-label { font-weight: 700; color: var(--primary-color); display: block; margin-bottom: 3px; }
        ...
        .skill-tag {
            ...
            padding: 4px 10px; border-radius: 20px; font-size: 0.85em; font-weight: 600; display: inline-block; position: relative;
        }

        .edu-table { width: 100%; border-collapse: collapse; font-size: 0.9em; }
        .edu-table th { text-align: left; padding: 5px 0; border-bottom: 2px solid #ccc; color: var(--primary-color); font-weight: bold; }
        ...
        .footer-sign { display: flex; justify-content: space-between; margin-top: 20px; align-items: flex-end; padding-top: 10px; border-top: 2px solid #eee; }
        ...
        body.edit-mode .add-btn { display: inline-block; background: var(--primary-color); color: white; border: none; padding: 5px 10px; font-size: 0.7rem; margin-top:10px; cursor: pointer; border-radius: 3px; }
        ...
        body.edit-mode .section:hover .remove-section-btn { display: block; } 
        ...
        .sidebar body.edit-mode [contenteditable="true"] { background-color: rgba(0,0,0,0.05); border-bottom: 1px dashed #999; }
        body.edit-mode [contenteditable="true"]:focus { outline: 2px solid var(--primary-color); background-color: white; color: black; }
        ...
        .editor-panel h3 { color: var(--header-bg); border-bottom: 2px solid var(--primary-color); padding-bottom: 10px; margin-bottom: 5px; }
        ...
        @media print {
            ...
            .header-section { padding-left: var(--content-padding) !important; padding-right: var(--content-padding) !important; margin-bottom: 0 !important; }
            .contact-bar { padding-left: var(--content-padding) !important; padding-right: var(--content-padding) !important; gap: var(--item-gap) !important; margin-bottom: var(--section-gap) !important; margin-top: 0 !important; }
            .main-content { padding: 0 30px 30px var(--content-padding) !important; gap: var(--section-gap) !important; }
            .sidebar { width: var(--sidebar-width) !important; gap: var(--section-gap) !important; padding: 0 20px 30px 20px !important; }
            ...
            .contact-item:not(:last-child)::after { content: "|"; right: -10px; color: rgba(255,255,255,0.5); }
...
<body class="edit-mode">
    ...
    <div class="resume-page" id="resumeArea">
        ...
        <div class="contact-bar" id="contactList">
            ...
            <button class="add-btn" onclick="addContact()" style="margin-left:10px; background:rgba(0,0,0,0.3);">+</button>
        </div>
        ...
        <div class="resume-body">
            ...
            <aside class="sidebar">
                ...
                <button class="add-btn" onclick="addSidebarSection()" style="margin-top:20px;">+ Add Sidebar List</button>
    ...
    <div class="editor-panel">
        ...
        <div class="control-group">
            ...
            <input type="range" min="15" max="50" value="20" oninput="updateVar('--section-gap', this.value + 'px')">
        </div>
    ...
    <script>
        ...
        function addContact() {
            ...
            newDiv.innerHTML = `<div contenteditable="true">New Contact</div><button class="remove-btn-skill" onclick="removeElement(this.parentElement)">x</button>`;
        ...
        // --- NEW FUNCTIONS FOR CUSTOM SECTIONS ---
        ...
        function addMainSection() {
            ...
            div.innerHTML = `
                ...
                <div class="entry">
                    <div class="entry-content" contenteditable="true">
                        Add your details here. Click to edit this text.
                    </div>
                </div>
        ...
        function addSidebarSection() {
            ...
            // Unique ID for list container to add items to it
