...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['resume_content'])) {
    ...
    $filename = "resume_elegant_" . date('Y-m-d_H-i') . ".html";
    ...
    <head>
        ...
        <style>
            ...
            .contact-item:not(:last-child)::after { content: '•'; position: absolute; right: -10px; color: #c0a375; }

            /* PRINT SPECIFIC: HIDE FORM ELEMENTS */
            /* 1. Radio Buttons */
            input[type='radio'] { display: none; }
            .radio-group label { display: none; } 
            .radio-group label.active-radio { display: inline; } /* Only show selected label */
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .entry-date { font-weight: 400; font-size: 0.9em; color: var(--text-light); text-align: right; min-width: 100px; font-style: italic; }
        .entry-subtitle { font-weight: 700; color: var(--accent-color); font-size: 0.9em; margin-bottom: 5px; text-transform: uppercase; letter-spacing: 1px; }
        .entry-content { font-size: 0.95em; line-height: var(--line-height); color: #444; text-align: justify; }

        .sidebar-item { font-size: 0.9em; line-height: 1.5; }
        .sidebar-label { 
            font-family: 'Playfair Display', serif; 
            font-weight: 700; 
            color: #000; 
        ...
        .radio-group label { margin-right: 8px; font-size: 0.9em; cursor: pointer; }
        select.sidebar-select { 
            width: 100%; border: none; background: transparent; font-family: inherit; font-size: inherit; color: inherit; cursor: pointer; padding: 0;
        }
        ...
        .edu-table th { text-align: left; padding: 5px 0; border-bottom: 1px solid #ccc; font-family: 'Playfair Display', serif; }
        .edu-table td { padding-top: calc(var(--item-gap) * 0.5); padding-bottom: calc(var(--item-gap) * 0.5); border-bottom: 1px solid #eee; vertical-align: top; padding-right: 10px; position: relative; }

        .footer-sign { display: flex; justify-content: space-between; margin-top: 30px; align-items: flex-end; padding-top: 10px; border-top: 1px solid #eee; }
        ...
        .btn-primary { background-color: #444; color: white; } .btn-primary:hover { opacity: 0.9; }

        /* UI Controls */
        .ui-controls, .add-btn, .remove-btn, .remove-btn-skill { display: none; }
        body.edit-mode .ui-controls { display: block; margin-bottom: 5px;}
        body.edit-mode .add-btn { display: inline-block; background: var(--accent-color); color: white; border: none; padding: 5px 10px; font-size: 0.7rem; margin-top:10px; cursor: pointer; border-radius: 3px; }
        ...
        .remove-btn { top: 50%; right: 0; transform: translateY(-50%); width: 20px; height: 20px; font-size: 10px; }
        ...
        .editor-panel h3 { color: #333; border-bottom: 2px solid var(--accent-color); padding-bottom: 10px; margin-bottom: 5px; }
        ...
        @media print {
            ...
            .header-section { margin-bottom: var(--section-gap) !important; }
            .contact-bar { gap: var(--item-gap) !important; }
            .sidebar { width: var(--sidebar-width) !important; gap: var(--section-gap) !important; padding-right: 20px !important; }
            .main-content { padding-left: 30px !important; gap: var(--section-gap) !important; }
            ...
            .contact-item:not(:last-child)::after { content: "•"; right: -10px; color: #c0a375; }
...
<body class="edit-mode">
    ...
    <script>
        window.onload = function() {
            ...
            updateRadioClasses(); // Initialize radio classes on load
        };
        ...
        function prepareSave() {
            ...
            // 1. Radio Buttons: Set 'checked' attribute AND class for display
            updateRadioClasses();
